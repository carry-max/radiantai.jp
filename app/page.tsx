  ...
  return <div className="portal-page landing-page">
    ...
    <main>
      <section className="landing-hero">
        <div className="landing-copy"><p className="eyebrow"><Sparkles /> VALORANT POST-MATCH COACH</p><h1>試合判断と撃ち合いを、<span>別々に伸ばす。</span></h1><p>立ち回りは、見たいリプレイを自分で選ぶか、Riot APIからAIに任せて最大50試合を分析。ミクロはOverwolfがデス前後を自動保存し、映像から直す行動を1つに絞ります。</p><div className="landing-actions"><a className="portal-primary" href="/analysis">無料で分析を試す <ArrowRight /></a><a className="portal-secondary" href="/dashboard">成長グラフを見る</a></div><small><ShieldCheck /> AIに任せる立ち回りは録画不要。ミクロも手動録画・アップロード不要です。</small></div>
        <div className="landing-visual" aria-label="分析から成長記録までの流れ"><div className="landing-score"><small>NEXT FOCUS</small><strong>ピーク前に照準の高さを確認</strong><span>根拠 3 / 6 フレーム</span></div><div className="landing-rings"><span>MICRO</span><b>60</b><small>この場面の評価</small></div><div className="landing-signal"><i /><span>立ち回りとミクロを切替</span></div></div>
      </section>
      <section className="landing-path" aria-labelledby="path-title"><div><p className="eyebrow">HOW IT WORKS</p><h2 id="path-title">試合後、自動で改善点まで整理</h2></div><ol><li><span>01</span><Crosshair /><strong>データを自動取得</strong><p>Riot APIとOverwolfが、戦績とデスクリップを試合後に準備します。</p></li><li><span>02</span><BrainCircuit /><strong>AIで二段解析</strong><p>AIが試合を分類・観測し、改善点を分かりやすく整理します。</p></li><li><span>03</span><LayoutDashboard /><strong>成長を残す</strong><p>12項目のグラフと30日ミッションで変化を追います。</p></li></ol></section>
