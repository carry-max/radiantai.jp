...
export default function LegalPage() {
  ...
  return <main className="legal-page"><Link href="/">← Radiant Reviewに戻る</Link><h1>販売条件・運営情報</h1>
    ...
    <h2>特定商取引法に基づく表記</h2><dl>
      ...
      <dt>利用範囲・上限</dt><dd>60分以内の対応録画が対象です。Replay Coachはデス前20秒〜後5秒、AIMのWindows自動保存は死亡前25秒〜後5秒の30秒クリップ、ブラウザ手動確認は選択時刻の前後0.4秒、Deep Coachは指定した10秒〜5分の区間から最大6枚を解析します。Riot AIはRiot公式承認後、Riotアカウント連携とWindows版Radiant AIアプリが必要です。1アカウント1日12回（失敗・保留を含む、日本時間）まで受け付けます。全体の受付上限や混雑により翌日以降の受付となる場合があります。未使用枠の繰越はありません。</dd>
