...
export function PricingView() {
  ...
  return <div className="portal-page pricing-page"><SiteHeader current="pricing" /><main className="portal-main"><PageLead eyebrow="PRICING" title="月額900円、3つの解析枠" description="立ち回りは最大50試合、ミクロは最大5試合、Deepは最大2試合。未使用分は月2試合まで別モードへ振替できます。" />
