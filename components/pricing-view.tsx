...
export function PricingView() {
  ...
  return <div className="portal-page pricing-page"><SiteHeader current="pricing" /><main className="portal-main"><PageLead eyebrow="PRICING" title="プレイ量に合わせた、2つのプラン" description="デス原因・AIM・ラウンドレビューは同料金。1試合あたり180円相当で、選んだ3場面まで分析できます。" />
    ...
    <section className="pricing-rules"><ShieldCheck /><div><h2>1試合分の数え方</h2><p>同じ録画から合計3解析。デス原因・AIM・ラウンドレビューへ自由に配分できます。保存済みの同じ結果を再表示しても枠は減りません。</p><p>PayPayは30日間の一回払い、カードは月額自動更新です。無料体験から自動的に有料へ切り替わりません。</p></div></section>
  </main></div>;
}
